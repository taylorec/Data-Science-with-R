...
adult <- read.csv("C:/Program Files/R/R-Course-HTML-Notes/R-for-Data-Science-and-Machine-Learning/Training Exercises/Machine Learning Projects/CSV files for ML Projects/adult_sal.csv")
head(adult)
...
#Accuracy
(table.acc[1]+table.acc[4])/sum(table.acc)

#Recall
table.acc[1]/sum(table.acc[1]+table.acc[3])

#Precision
table.acc[1]/sum(table.acc[1]+table.acc[2])
